use crate::isa::{
    description::{format2, format3, format4, format_offset, Describer, Description, MASK_5BIT},
    instruction::{
        rv32f::{
            ...
            Self::TypeR {
                ...
                match opcode {
                    Rv32fOpcodeR::FmaddS => (
                        ...
                        format4(opcode.to_string(), rd, rs1, rs2, &rs3),
                    ...
                    Rv32fOpcodeR::FsqrtS => (
                        ...
                        format2(opcode.to_string(), rd, rs1),
                        "fsqrt.s rd,rs1",
                        "f[rd] = sqrt(f[rs1])",
                    ),
                    Rv32fOpcodeR::FsgnjS => (
