...
impl fmt::Display for Rv32iOpcodeI {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match *self {
            ...
            Rv32iOpcodeI::FenceI => f.write_str("Rv32i::FenceI"),
            Rv32iOpcodeI::Ecall => f.write_str("Rv32i::Ecall"),
            Rv32iOpcodeI::Ebreak => f.write_str("Rv32i::Ebreak"),
            Rv32iOpcodeI::Csrrw => f.write_str("Rv32i::Csrrw"),
            Rv32iOpcodeI::Csrrs => f.write_str("Rv32i::Csrrs"),
            Rv32iOpcodeI::Csrrc => f.write_str("Rv32i::Csrrc"),
            Rv32iOpcodeI::Csrrwi => f.write_str("Rv32i::Csrrwi"),
            Rv32iOpcodeI::Csrrsi => f.write_str("Rv32i::Csrrsi"),
            Rv32iOpcodeI::Csrrci => f.write_str("Rv32i::Csrrci"),
